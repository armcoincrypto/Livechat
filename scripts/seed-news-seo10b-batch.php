...
<?php
/**
 * SEO-10B — Priority 2 legacy content upgrade (CMS + snapshots).
 */
...
$configPath = __DIR__ . '/../storage/app/seo/news-seo10b-config.json';
...
$priority2 = array_map('intval', $config['priority2_ids'] ?? []);
