...
trait GeneratedPayInputs
{
    ...
    public function getPayApiAuthToken(): ?string
    {
        /** @var \iEXPackages\Payments\Core\Engine\AbstractRequest $this */
        $value = $this->inputs('pay')->get('api_auth_token');

        return $value === null ? null : (string) $value;
    }

    public function getPayApiSignToken(): ?string
    {
        /** @var \iEXPackages\Payments\Core\Engine\AbstractRequest $this */
        $value = $this->inputs('pay')->get('api_sign_token');
