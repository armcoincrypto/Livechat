...
/**
 * Базовый Request для шлюза Alfabitpay.
 *
 * Здесь:
...
abstract class AbstractRequest extends BaseAbstractRequest
{
    ...
    {
        return 'https://pay.alfabit.org';
    }

    /**
     * HTTP-настройки AlfabitPay (только отличия).
     *
     * Общий GatewayHttpClient:
     * - сделает timeout/retry/baseUrl/asJson/asForm
     * - залогирует в БД через GatewayLogger
     * - замаскирует секреты
     */
