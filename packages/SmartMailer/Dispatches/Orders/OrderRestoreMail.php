...
class OrderRestoreMail extends SmartMailable
{
    ...
    {
        $this->setSubject(__('smart-mailer::messages.order_restored_subject', ['id' => current_order_id($this->order)]))
            ->markdown('smart-mailer::orders.order_restore', [
